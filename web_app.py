...
# ============================================================
# ФРЕШЕР — ИСПРАВЛЕННЫЙ С 3 ПОПЫТКАМИ
# ============================================================
...
# ============================================================
# HTML — ПОЛНЫЙ КОД С ФРЕШЕРОМ В СТИЛЕ rblxrefresh
# ============================================================
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            ...
            min-height: 100vh;
            padding: 24px;
            background-image: url('https://images.unsplash.com/photo-1534796637412-6d6e4c9d0d1a?w=1600');
        ...
        .method-group .method-btn.active {
            background: linear-gradient(135deg, #6c5ce7, #a855f7);
            color: #fff;
            box-shadow: 0 4px 16px rgba(108,92,231,0.3);
        }
        .method-group .method-btn:hover:not(.active) { color: #c8c0ff; }
